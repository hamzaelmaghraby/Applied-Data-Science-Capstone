...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        if entered_site == 'CCAFS LC-40':
            ...
            names='class', 
            title='CCAFS LC-40 success counts.')
            return fig
            ...
            fig = px.pie(filtered_df, values='count', 
            names='class', 
            title='VAFB SLC-4E success counts.')
            return fig
            ...
            fig = px.pie(filtered_df, values='count', 
            names='class', 
            title='KSC LC-39A success counts.')
            return fig
        else:
            ...
            fig = px.pie(filtered_df, values='count', 
            names='class', 
            title='CCAFS SLC-40 success counts.')
            return fig
...
def get_scatter_ploy(entered_site,entered_value):
    print('here')
    filtered_df = spacex_df
    low, high = entered_value
    print(low, high)
    ...
    if entered_site == 'ALL':
        ...
        if entered_site == 'CCAFS LC-40':
            filtered_df = filtered_df[filtered_df['Launch Site'] == 'CCAFS LC-40']
            fig = fig = px.scatter(filtered_df, 
            x="Payload Mass (kg)", 
            y='class', 
            color='Booster Version Category')
            return fig
